...
do {
    infile >> new_person.last_name >> new_person.first_name >> new_person.id >> new_person.age;
    people[i] = new_person;
...
int main(int argc, char** argv) {
  ...
  cout << "The average age of the " << n << " people is: " << avg_age  << endl;
  cout << "The maximum age of the " << n << " people is: " << max_age  << endl;
